...
namespace ReservationBrute.Controllers
{
    ...
    {
        const string ServiceBusConnectionString = "Endpoint=sb://servicebustp041192.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=svvJVxT/Huw4boAOY5sETvLAIsgWpJtZ7ZIUsrPRxJ8=";
        const string QueueName = "ReservationBruteQueue";
